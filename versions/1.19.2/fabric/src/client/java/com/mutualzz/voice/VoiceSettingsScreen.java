...
public final class VoiceSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        muteUserButton = addRenderableWidget(new Button(cx - 140, y, 280, 20, muteUserLabel(), b -> {
            String id = VoiceSettings.get().selectedUserId();
        ...
        addRenderableWidget(new Button(cx - 100, Math.min(y, height - 28), 200, 20, CommonComponents.GUI_DONE, b -> onClose()));
