...
version = "${rootProject.property("mod_version")}+mc1.19.4-forge"
...
dependencies {
    ...
    "forge"("net.minecraftforge:forge:1.19.4-45.2.0")
...
val generateModMetadata = tasks.register<ProcessResources>("generateModMetadata") {
    val replaceProperties = mapOf(
        "minecraft_version" to "1.19.4",
        "minecraft_version_range" to "[1.19.4,1.20)",
        "forge_version" to "45.2.0",
