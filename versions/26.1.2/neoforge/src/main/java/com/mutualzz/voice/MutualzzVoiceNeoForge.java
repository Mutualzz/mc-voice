 ...
 * NeoForge {@link KeyModifier} is single-key only (no Ctrl+Shift combos like Amecs on Fabric),
 * so deafen / mic-sensitivity defaults use Alt instead of Ctrl+Shift.
 */
