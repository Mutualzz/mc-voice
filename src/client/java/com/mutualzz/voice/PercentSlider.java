...
public final class PercentSlider extends AbstractSliderButton {
    ...
    public PercentSlider(
        ...
        super(x, y, width, height, Component.empty(), toProgress(current.getAsDouble(), min, max));
        this.label = label;
        this.min = min;
        this.max = max;
    ...
    public void refreshFromSettings() {
        setValue(toProgress(current.getAsDouble(), min, max));
        updateMessage();
    }
    ...
    protected void updateMessage() {
        ...
        setMessage(Component.literal(label + ": " + pct + "%"));
    }
